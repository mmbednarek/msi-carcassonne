...
void HeuristicPlayer::await_turn(game::Game &game) {
   game.on_next_move([this](game::Game &game, Player player, game::FullMove) {
      if (player != m_player)
         return;
...
game::FullMove HeuristicPlayer::make_move(game::Game &game, const Parameters &params) noexcept {
