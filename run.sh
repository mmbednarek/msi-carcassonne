cmake -G Ninja -DCMAKE_EXPORT_COMPILE_COMMANDS=ON --target carcassonne_training -D CMAKE_C_COMPILER=gcc-10 -D CMAKE_CXX_COMPILER=g++-10 -S . -B out/build_terminal
# make -C out/build_terminal -j12 && ./out/build_terminal/src/bin/evolution/msi_evolution_bin
ninja carcassonne_training -C out/build_terminal -j16 && #-j${nproc} && 
...
./out/build_terminal/src/bin/training/carcassonne_training -v -s 456
